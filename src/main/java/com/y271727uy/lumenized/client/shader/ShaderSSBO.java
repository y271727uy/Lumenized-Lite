...
public class ShaderSSBO {
	...
	public ShaderSSBO() {
		if (!support()) {
			...
			LumenizedConstants.LOGGER.error(errorMessage);
	...
	public void close() {
		if (!inValid) {
			...
			LumenizedConstants.LOGGER.error("try closing an already closed ShaderStorageBufferObject");
		}
	}
	...
	public void bindBuffer() {
		if (!inValid){
			...
			LumenizedConstants.LOGGER.error("try to use an already close ShaderStorageBufferObject");
		}
	}
