package com.y271727uy.lumenized.client;
 ...
 * @author KilaBash
 * @date 2022/05/02
 * @implNote com.y271727uy.lumenized.client.rendertype
 */
public class LumenizedRenderTypes {
    ...
    public static Pair<ShaderInstance, Consumer<ShaderInstance>> registerShaders(ResourceManager resourceManager) {
        try {
            return Pair.of(new ShaderInstance(resourceManager, Objects.requireNonNull(ResourceLocation.tryParse(LumenizedConstants.MOD_ID + ":" + "rendertype_armor_cutout_no_cull")).toString(), DefaultVertexFormat.NEW_ENTITY),
