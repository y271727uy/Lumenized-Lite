 ...
 */
public class LumenizedConstants {

	public static final String MOD_ID = "lumenized";
	public static final String MOD_NAME = "Lumenized Lite";
	...
	public static final String SHIMMER_SHADERS_PROPERTIES_PREFIX = "lumenized.config.";
